...
const Header = (): JSX.Element => {
    ...
    return (
        <header className="flex items-center justify-between gap-4 py-7 px-4 sticky top-0 bg-white z-50 lg:px-24">
            <Link href="/">
                <Image className="w-full h-3/5" src="/logo.svg" alt="Frameio Stores" width={100} height={100} />
            </Link>
            ...
            <div className="flex items-center gap-12">
                <button className="relative" type="button" onClick={() => setModalIsActive(true)}>
                    ...
                    <span className="absolute bg-brand-red text-white -top-[90%] -right-4 font-medium rounded-full text-xs px-1.5 py-0.5 flex place-items-center place-content-center">
                        3
                    </span>
                </button>
